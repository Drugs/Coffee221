        ...
        <div class="row justify-content-center">
            <div class="col-6">
                <div class="col-12">
                    ...
                    <div class="form-floating">
                        <input type="tel" class="form-control" name='telefone' data-mask="(00) 0000-0000" maxlength="15" onkeypress="mascara(this)" pattern="^\(?\d{2}\)?[\s-]?[\s9]?\d{4}-?\d{4}$" required value="<?php echo $result['telefone']; ?>">
