...
join endereco on pessoa.id_pessoa=endereco.fk_id_pessoa where pessoa.id_pessoa=''
";
...
?>
  ...
  foreach($result as $endereco){
     ...
     <td><a class='btn btn-warning' href='.php?var={$endereco['id_pessoa']}'>Atualizar</a> 
     </td>
     <td><a class='btn btn-outline-warning' href='.php?var={$endereco['id_pessoa']}'>Deletar</a> </td>
               </tr>";
                 }
