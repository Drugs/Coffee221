...
<body class="">
	...
	<!-- AJAX dos cards -->
	<!--<script>
		function rodinhas(id_do_carrinho) {
			const xhttp = new XMLHttpRequest();
			xhttp.onload = function() {
				document.getElementById("alvo").innerHTML = this.responseText;
			}
			xhttp.open("GET", "codigoteste.php?id=" + id_do_carrinho);
			xhttp.send();
		}
	</script>-->
					...
					<div class="card-body">
						<p class="card-text">
							<font style="vertical-align: inherit;">
								...
								<font style="vertical-align: inherit;">
									<h6 class="card-growth">Capsula Caramelo Cremoso, uma explosão de sabores com a doçura na medida certa. Com notas de baunilha com canela e caramelo.</h6>
								</font>
							</font>
						</p>
						<div class="d-flex justify-content-between align-items-center">
